...
from tkinter import DISABLED, Button, Menu, messagebox
from tkinter import font

root = tk.Tk()
root.title('Tic Tac Toe')

# X clicks first, so true
clicked = True
count = 0
...
def checkifwon():
    ...
    if b1["text"]=="X" and b2["text"]=="X" and b3["text"]=="X":
      ...
      b3.config(bg="red")
      winner=True
      messagebox.showinfo("Tic Tae Toe","X wins!")
      disable_all_buttons()
...
#check for 0
      ...
      b3.config(bg="red")
      winner=True
      messagebox.showinfo("Tic Tae Toe","0 wins!")
      disable_all_buttons()
...
def b_click(b):
    ...
    if   b["text"] == " " and clicked==True:
        ...
        messagebox.showerror("Tic Tac Toe", "That box has been selected")
